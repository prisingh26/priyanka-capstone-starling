...
const LandingPage = () => {
  ...
  const howItWorks = [
    ...
    { step: 2, title: "Starling Analyzes Instantly", description: "Starling reads handwriting, checks answers, and finds patterns", color: "bg-rose-100 text-rose-600", image: stepAnalyze },
