      ...
      <div className="max-w-lg w-full space-y-8 text-center animate-fade-in">
        ...
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground">
            Amazing work today! Sprout is so proud of you!
          </p>
        </div>

        {/* Achievement Card */}
        <div className="sprout-card gradient-primary text-primary-foreground animate-pop-in">
        ...
        <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style={{ animationDelay: "0.7s" }}>
          <button
            ...
            className="flex-1 sprout-button-secondary flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={onGoHome}
            className="flex-1 sprout-button-primary flex items-center justify-center gap-2"
          >
